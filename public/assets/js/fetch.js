export const Fetch = {
    ...
    updateRandomRecipeWithData: function (data) {
        document.querySelector(".r_cards_container img").src = data.picture;
        ...
        document.querySelector(".r_cards_container div a").href = window.location.href + `user/${data.userSlug}`;
    }
