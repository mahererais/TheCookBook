...
| URL | Méthode HTTP | Controller | Méthode | Titre | Contenu | Commentaire | Name|
|--|--|--|--|--|--|--|--|
|`/recipe/review/{id}` | `GET` | `ReviewController` | `addReview` | Ajout d'un commentaire | Form addReview | {id} is the id of the recipe | tcb_front_review_addReview|
|`/recipe/review/{id}` | `POST` | `ReviewController` | `addReview` | # | Form addReview | {id} is the id of the recipe, redirecte to /recipe/{id}/{slug} | tcb_front_review_addReview |
