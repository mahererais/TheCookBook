 ...
 */
<<<<<<< HEAD:migrations/Version20230906204028.php
final class Version20230906204028 extends AbstractMigration
=======
final class Version20230908072102 extends AbstractMigration
>>>>>>> develop:migrations/Version20230908072102.php
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(64) NOT NULL, lastname VARCHAR(64) NOT NULL, picture VARCHAR(255) DEFAULT NULL, speciality VARCHAR(64) DEFAULT NULL, experience LONGTEXT DEFAULT NULL, presentation LONGTEXT DEFAULT NULL, status VARCHAR(64) NOT NULL, slug VARCHAR(64) NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
